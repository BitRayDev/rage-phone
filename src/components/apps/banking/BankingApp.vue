<template>
	<div class="banking-app app">
		<p class="banking-app__title app-title-text">Banking</p>
		<div class="banking-app__greeting banking-greeting">
		...
		<div class="banking-app__card banking-card">
			<div class="banking-card__header">
				<img class="banking-card__dollar-icon" src="@/assets/img/icons/dollar.svg" />
				<div>
		...
		<div class="banking-app__section banking-section" v-if="isSendSectionActive">
			<p class="banking-section__label">Money Transaction</p>
			<div class="banking-app__send-money banking-send-money">
				<input
		...
		<div class="banking-app__section banking-section" v-if="isTransactionsSectionActive">
			...
			<div class="banking-app__transactions">
				<div
					class="banking-app__transaction banking-transaction"
					v-for="transaction in recentTransactions"
				>
					<img
						class="banking-transaction__icon"
						:src="transaction.type === 'incoming' ? require('@/assets/img/icons/incoming-transaction.svg') : require('@/assets/img/icons/outcoming-transaction.svg')"
					/>
...
.banking-card {
	...
	background: url("../../../assets/img/credit-card-background.svg");
...
.banking-app {
	...
	background: url("../../../assets/img/backgrounds/purple.svg");
	background-size: 100% 100%;
